...
if [ "$USE_XCODE" == "yes" ]; then
	xcodebuild -project dnd3.xcodeproj -scheme dnd3 -configuration Release build
	xcodebuild -project dnd3.xcodeproj -scheme dnd3 -archivePath ./dnd3.xcarchive archive
else
