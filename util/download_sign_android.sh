...
KEYSTORE="$HOME/Documents/keystore-dnd3.jks"
...
mkdir -p signed
sign unsigned/dnd3-arm64-v8a.apk/app-arm64-v8a-release-unsigned.apk "signed/dnd3-$TAG-arm64-v8a.apk"
sign unsigned/dnd3-armeabi-v7a.apk/app-armeabi-v7a-release-unsigned.apk "signed/dnd3-$TAG-armeabi-v7a.apk"
sign unsigned/dnd3-release.aab/app-release.aab "signed/dnd3-$TAG.aab"
sign unsigned/dnd3-x86_64.apk/app-x86_64-release-unsigned.apk "signed/dnd3-$TAG-x86_64.apk"
sign unsigned/dnd3-x86.apk/app-x86-release-unsigned.apk "signed/dnd3-$TAG-x86.apk"
