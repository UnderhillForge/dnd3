...
dnd3 supports TGA types 1, 2, 3 & 10. While adding the support for
...
Note: dnd3 requires the optional TGA footer for a texture to load.
If a TGA image does not load in dnd3, append eight (8) null bytes,
