...
2. Before you start coding, consider opening an
   [issue on Github](https://github.com/dnd3-org/dnd3/issues) to discuss the
   ...
   [#dnd3-dev](https://docs.dnd3.org/about/irc/). Note that a proper IRC client
   is required to speak on this channel.

3. Start coding!
    - Refer to the
      [Lua API](https://github.com/dnd3-org/dnd3/blob/master/doc/lua_api.md),
      [dnd3 Documentation](https://docs.dnd3.org/) and other
      [documentation](https://github.com/dnd3-org/dnd3/tree/master/doc).
    - Follow the [C/C++](https://docs.dnd3.org/for-engine-devs/code-style-guidelines/) and
      [Lua](https://docs.dnd3.org/for-engine-devs/lua-code-style-guidelines/) code style guidelines.
    ...
    - To avoid conflicting changes between contributions, do not do the following manually. They will be done before each release.
      - Run `updatepo.sh` or update `dnd3.po{,t}` even if your code adds new translatable strings.
      - Update `dnd3.conf.example` and `settings_translation_file.cpp` even if your code adds new core settings.
...
5. Once you are happy with your changes, submit a pull request.
     - Open the [pull-request form](https://github.com/dnd3-org/dnd3/pull/new/master).
...
3. It follows the code style for
   [C/C++](https://docs.dnd3.org/for-engine-devs/code-style-guidelines/) or
   [Lua](https://docs.dnd3.org/for-engine-devs/lua-code-style-guidelines/).
...
2. Is it an issue with the dnd3 *engine*? If not, report it
   [elsewhere](http://www.dnd3.org/development/#reporting-issues).
3. [Open an issue](https://github.com/dnd3-org/dnd3/issues/new) and describe
   the issue you are having - you could include:
     - Error logs (check the bottom of the `debug.txt` file).
     - Screenshots.
     - Ways you have tried to solve the issue, and whether they worked or not.
     - Your dnd3 version and the content (games, mods or texture packs) you have installed.
...
The core translations of dnd3 are performed using Weblate. You can access
the project page with a list of current languages
[here](https://hosted.weblate.org/projects/dnd3/dnd3/).
...
[Translation](https://docs.dnd3.org/for-creators/translation/) for more information.

## Donations

If you'd like to monetarily support dnd3 development, you can find donation
methods on [our website](http://www.dnd3.org/development/#donate).

# Maintaining

* This is a concise version of the
  [Rules & Guidelines](https://docs.dnd3.org/for-engine-devs/) on the dnd3 Documentation.*

These notes are for those who have push access dnd3 (core developers / maintainers).

- See the [project organisation](https://docs.dnd3.org/for-engine-devs/organization/) for the people involved.
...
- Who intends to merge the pull-request should follow the commit rules:
    ...
    - `curl -Ls https://github.com/dnd3-org/dnd3/pull/1.patch | git am`
...
- Tag issues with the appropriate [labels](https://github.com/dnd3-org/dnd3/labels) for devices, platforms etc.

## Releasing a new version

*Refer to [docs.dnd3.org/for-engine-devs/releasing-dnd3](https://docs.dnd3.org/for-engine-devs/releasing-dnd3/)*
