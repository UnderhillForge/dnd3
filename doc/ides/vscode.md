...
When you open the dnd3 folder with VSCode, you should get a quick pick asking you for the default preset.
...
Follow the official documentation to install it and install dnd3 dependencies as explained in [Windows compilation process](../compiling/windows.md).
