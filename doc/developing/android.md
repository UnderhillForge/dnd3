...
The [Github Actions Workflow](https://github.com/dnd3-org/dnd3/actions?query=workflow%3Aandroid+event%3Apush)
...
## How to get debug output from dnd3 on Android
...
```
01-10 17:20:22.215 19308 20560 F libc    : Fatal signal 6 (SIGABRT), code -1 (SI_QUEUE) in tid 20560 (MinetestNativeT), pid 19308 (netest.dnd3)
...
01-10 17:20:22.288 20576 20576 F DEBUG   : pid: 19308, tid: 20560, name: MinetestNativeT  >>> net.dnd3.dnd3 <<<
...
Erase the app's memory of which version was installed: `adb shell run-as net.dnd3.dnd3 rm shared_prefs/MinetestSettings.xml`

If this doesn't work you can also uninstall it using `adb shell pm uninstall net.dnd3.dnd3`. You will obviously lose your data.
