...
libraries, build tools (CMake) or compilers dnd3 requires.
...
Being able to play dnd3 on a recent low-end phone is a reasonable target.
...
* Can we make it easier for users to build the library together with dnd3?
