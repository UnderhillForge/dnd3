...
This directory contains mostly reference documentation for the dnd3 engine.
...
- [lua_api.md](lua_api.md): Server Modding API reference. (Not only the Lua part,
    ...
    A rendered version is also available at <https://api.dnd3.org/>.
...
- [texture_packs.md](texture_packs.md): Layout and description of dnd3's
...
- [world_format.md](world_format.md): Structure of dnd3 world directories and
...
- [protocol.txt](protocol.txt): *Rough* outline of dnd3's network protocol.
...
- [developing/](developing/): Information about dnd3 development.
...
- [direction.md](direction.md): Information related to the future direction of
    dnd3. Commonly referred to as the roadmap document.
