...
* `name`: The texture pack name. Allows dnd3 to determine the texture pack name even if
...
the apple texture of dnd3 Game, add a PNG file named `default_apple.png`.
...
* `moon.png`: texture of the moon. Default texture is generated by dnd3
* `moon_tonemap.png`: tonemap to be used when `moon.png` was found
* `sun.png`: texture of the sun. Default texture is generated by dnd3
...
dnd3 has three modes for rendering leaves nodes if the node has the
