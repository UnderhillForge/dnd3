...
General options and their default values:
    ...
    BUILD_CLIENT=TRUE          - Build dnd3 client
    BUILD_SERVER=FALSE         - Build dnd3 server
    ...
    INSTALL_DEVTEST=FALSE      - Whether the Development Test game should be installed alongside dnd3
    ...
    VERSION_EXTRA=             - Text to append to version (e.g. VERSION_EXTRA=foobar -> dnd3 5.10.0-foobar)
