...
```bash
git clone --depth 1 https://github.com/dnd3-org/dnd3 dnd3
cd dnd3
```
...
codesign --force --deep -s - --entitlements ../misc/macos/entitlements/debug.entitlements macos/dnd3.app
```
