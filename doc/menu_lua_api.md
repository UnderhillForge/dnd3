dnd3 Lua Mainmenu API Reference 5.16.0
========================================
...
* `core.get_modpaths()` (possible in async calls)
    * returns table of virtual path to global modpaths, where mods have been installed
      ...
      directories by dnd3 -- they might be read-only.

      Ex:

      ```lua
      {
          mods = "/home/user/.dnd3/mods",
          share = "/usr/share/dnd3/mods", -- only provided when RUN_IN_PLACE=0
