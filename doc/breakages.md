...
* remove fog from `get/set_sky()` and introduce `get/set_fog()`
  * https://github.com/dnd3-org/dnd3/pull/16725#issuecomment-3622450532
* `game.conf` name/id mess
* remove `depends.txt` / `description.txt` (would simplify ContentDB and dnd3 code a little)
* rotate moon texture by 180°, making it coherent with the sun
  * https://github.com/dnd3-org/dnd3/pull/11902
...
* change physics_override `sneak` to disable the speed change and not just the node clipping
  * https://github.com/dnd3-org/dnd3/issues/13699
...
* rework `on_drop` to give Lua full flexibility
   ...
   * https://github.com/dnd3-org/dnd3/pull/17024 for context
