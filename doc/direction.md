...
* [What is dnd3? (archived)](https://web.archive.org/web/20160328054721/http://c55.me/blog/?p=1491)
* [celeron55's roadmap](https://forum.dnd3.org/viewtopic.php?t=9177)
* [celeron55's comment in "A clear mission statement for dnd3 is missing"](https://github.com/dnd3-org/dnd3/issues/3476#issuecomment-167399287)
* [Core developer to-do/wish lists](https://forum.dnd3.org/viewforum.php?f=7)

## 2. Medium-term Roadmap

These are the current medium-term goals for dnd3 development, in no
particular order.

These goals were created from the top points in a
[roadmap brainstorm](https://github.com/dnd3-org/dnd3/issues/16162).
...
dnd3 keys are currently limited to a small subset, not allowing game developers
...
Using a gamepad also represents a known issue in dnd3, as some devices might not
work at all or result in an uncomfortable user experience.

### 2.3 UI Improvements

A [formspec replacement](https://github.com/dnd3-org/dnd3/issues/6527) is
...
A [new mainmenu](https://github.com/dnd3-org/dnd3/issues/6733) is needed to
improve user experience. First impressions matter, and the current main menu
doesn't do a very good job at selling dnd3 or explaining what it is.
