...
// OpenGL < 4.3 does not support continued preprocessor lines
	...
	// Pixel art: scale geometry in clip-space so nodes appear visually smaller.
	// Physics/collision are unaffected because this only touches gl_Position.
	gl_Position.xy *= VOXEL_VISUAL_SCALE;
