...
#    This file contains a list of all available settings and their default value for dnd3.conf

#    By default, all the settings are commented and not functional.
#    Uncomment settings by removing the preceding #.

#    dnd3.conf is read by default from:
#    ../dnd3.conf
#    ../../dnd3.conf
#    Any other path can be chosen by passing the path as a parameter
#    to the program, eg. "dnd3.exe --config ../dnd3.conf.example".
	...
	for _, entry in ipairs(settings) do
		if entry.type == "category" then
			...
			if entry.type == "key" then
				local line = "See https://docs.dnd3.org/for-players/controls/"
				insert(result, "#    " .. line .. "\n")
			end
...
local file = assert(io.open("dnd3.conf.example", "w"))
...
-- If 'dnd3.conf.example' appears in the 'bin' folder, the line below may have to be
