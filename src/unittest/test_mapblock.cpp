...
public:
	...
	// Tests loading a MapBlock from dnd3-c55 0.3
...
void TestMapBlock::testSave29(IGameDef *gamedef)
{
	...
	/*
	 * Quick note:
	 * dnd3 deals with MapBlocks that violate these invariants (mostly) fine,
...
void TestMapBlock::testLoadNonStd(IGameDef *gamedef)
{
	 ...
	 * transition to 16-bit: <https://github.com/dnd3-org/dnd3/commit/ea62ee4b61371107ef3d693bda4c410ba02ca7e6>
