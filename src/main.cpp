...
#error dnd3 cannot be built without exceptions or RTTI
#endif

#if defined(__MINGW32__) && !defined(__clang__)
// see <https://github.com/dnd3-org/dnd3/issues/14140> or
// <https://github.com/dnd3-org/dnd3/issues/10137> for some of the issues we had
#error ==================================
#error MinGW gcc has a broken TLS implementation and is not supported for building \
	dnd3. Look at testTLS() in test_threading.cpp and see for yourself. \
	Please use a clang-based compiler or alternatively MSVC.
#error ==================================
#endif

// TODO: dnd3.conf with migration
#define CONFIGFILE "dnd3.conf"
...
int main(int argc, char *argv[])
{
...

	{
		...
		if (str_starts_with(exe_name, "dnd3")) {
#if CHECK_CLIENT_BUILD()
