...
// On Windows export some driver-specific variables to encourage dnd3 to be
...
bool setSystemPaths()
{
	...
	if (len == 0) {
		...
		// TODO: dnd3 with migration
		path_user = std::string(buf) + DIR_DELIM "dnd3";
	} else {
...
bool setSystemPaths()
{
	...
	if (user_path_env) {
		...
		// TODO: dnd3 with migration
		path_user = std::string(getHomeOrFail()) + DIR_DELIM "." "dnd3";
	}
...
bool setSystemPaths()
{
	...
	if (user_path_env) {
		...
		path_user = std::string(getHomeOrFail())
			+ "/Library/Application Support/" "dnd3";
	}
	return true;
}
...
#  else
	...
	if (cache_dir && cache_dir[0] != '\0') {
		// TODO: dnd3 with migration
		path_cache = std::string(cache_dir) + DIR_DELIM "dnd3";
	} else if (home_dir) {
 ...
 * read more: <https://forum.dnd3.org/viewtopic.php?t=30509>
 *
